...
<body>
    ...
    <div class="container-fluid" style="width: 880px; height: 680">
            ...
            <div class="row mt-2">
                ...
                <div class="col-3 col-sm-3 col-md-3 col-lg-3">
                    <div class="mt-2">
                        ...
                        <div class="p-2 mt-4 rounded-lg d-flex align-items-center bg-white border shadow" style="height: 108px; background-color: #f1f4f9;">
                            <div class="d-flex align-items-center flex-grow-1">
                                <!-- Hình ảnh -->
                                <div>
                                    <img src="../page/assets/images/courses-03.jpg" alt="{product.name}" style="width: 40px; height: 40px; border-radius: 25%;">
                                </div>

                                <!-- Tiêu đề -->
                                <div class="ml-2">
                                    <span class="d-block font-weight-bold">Slack Ltd</span>
